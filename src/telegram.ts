import { emitEvent, init, mockTelegramEnv, viewport } from '@tma.js/sdk-react';

export function initTelegram() {
  // 1. Mock the environment if we are developing locally (Vite's DEV mode)
